...
use DL\FrontendBundle\Entity\Contact;
...
class ContactController extends Controller
{
    ...
    public function createConctactAction(Request $request)
    {
        ...
        $form = $this->createFormBuilder($contact)
            ->add('name', TextType::class, array('label' => 'Nom et prénom', 'attr' => array('class' => 'form-control', 'style' => 'margin-bottom:15px')))
            ...
            ->add('message', TextareaType::class, array('label' => 'Msessage', 'attr' => array('class' => 'form-control')))
        ...
        return $this->render('DLFrontendBundle:Front:Contact.html.twig', array('form' => $form->createView()));
